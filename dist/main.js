...
class MenuUI {
  ...
  static inboxButton() {
    ...
    myInbox.innerHTML = "";
    let items = _storage__WEBPACK_IMPORTED_MODULE_1__["default"].getAllItems();
    console.log(items);
    items.forEach((el) => {
      let key = el.name;
  ...
  static displayTasks(key, value) {
    ...
    date.textContent = _storage__WEBPACK_IMPORTED_MODULE_1__["default"].formatDate(value);
  ...
  static todayTasks() {
    ...
    let today = new Date();
    myInbox.innerHTML = "";
    console.log((0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(today));
    for (let i = 0; i < localStorage.length; i++) {
      let key = localStorage.key(i);
      let value = JSON.parse(localStorage.getItem(key));
      let toCompare = new Date(value.dueDate);
      console.log((0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(toCompare));
      if ((0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(toCompare)) {
        console.log("yes");
        MenuUI.displayTasks(key, value);
      } else {
  ...
  static weekTasks() {
    ...
    for (let i = 0; i < localStorage.length; i++) {
      ...
      let value = JSON.parse(localStorage.getItem(key));
      let toCompare = new Date(value.dueDate);
      console.log((0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(toCompare, nextWeek));
      if ((0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(toCompare, 0)) {
        console.log("yes");
        MenuUI.displayTasks(key, value);
      } else {
        console.log("not working");
