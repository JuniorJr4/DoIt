...
class MenuUI {
  ...
  static weekTasks() {
    ...
    items.forEach((el) => {
      let key = el.name;
      let value = new Date(el.dueDate);
      if ((0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(value, 0)) {
        console.log("yes");
        MenuUI.displayTasks(key, value);
      } else {
        console.log('suck it');
