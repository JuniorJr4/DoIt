...
class MenuUI {
  ...
  static submitTaskBtn() {
    ...
    let newTask = new _task__WEBPACK_IMPORTED_MODULE_0__["default"](taskName.value, dueDate);
    _storage__WEBPACK_IMPORTED_MODULE_1__["default"].storeTask(newTask);
  ...
  static displayTasks(key, value) {
    ...
    date.textContent = _storage__WEBPACK_IMPORTED_MODULE_1__["default"].formatDate(value.dueDate);
  ...
  static todayTasks() {
    ...
    for (let i = 0; i < localStorage.length; i++) {
      ...
      console.log((0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(toCompare, today));
      if ((0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(toCompare, today)) {
        console.log("yes");
        MenuUI.displayTasks(key, value);
      } else {
  ...
  static weekTasks() {
    ...
    for (let i = 0; i < localStorage.length; i++) {
      ...
      let value = JSON.parse(localStorage.getItem(key));
      let toCompare = new Date(value.dueDate);
      console.log((0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(toCompare, nextWeek));
      if ((0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(toCompare, nextWeek)) {
        console.log("yes");
        MenuUI.displayTasks(key, value);
      } else {
        console.log("not working");
...
class Storage {
  ...
  static formatDate(date) {
    if (date !== "") {
      const formattedDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(new Date(date), "dd/MM/yyyy");
